...
def compute_states(init_state, controls, environment, time_step=1):
    states = []
    x, y, v, h = init_state
    wind_speed, wind_heading = environment
...
def formulate_objective(init_states, desired_states, environment, time_step=1, state_weight=0.1, 
    ...
    def objective(params):
        states = compute_states(init_states, params, environment, time_step=time_step)
